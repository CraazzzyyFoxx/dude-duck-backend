...
async def create_preorder_message(
    ...
    message_service.send_sent_preorder_notify(order.order_id, messages)
    return messages
...
async def update_preorder_message(
    ...
    message_service.send_edited_preorder_notify(order.order_id, messages)
    return messages
...
async def delete_preorder_message(
    ...
    message_service.send_deleted_preorder_notify(order.order_id, messages)
    return messages
